        ...
        http
                ...
                .authorizeHttpRequests(
                        ...
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui/index.html",
                                            ...
                                            "/freeBulletinBoard", "/announcement", "/announcement/mainBanner", "/announcementPost/images/**", "/getAllSubjectInfo", "/subjectInfoDetail/{offeredSubjectsId}", "/teacher/subject/images/{fileNo:.+}", "/teacher/video-management/images/{fileNo:.+}", "/teacher/video-management/delete-video/{offeredSubjectsId}/{videoId}", "/Videoplayer/videoList/{episodeId}/{offeredSubjectsId}", "/slp/images/{fileNo:.+}", "/sid/images/{fileNo:.+}", "/op/images/{fileNo:.+}", "/lecture/images/{fileNo:.+}", "/courseComplete/download/certificate/**")
